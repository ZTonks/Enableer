// <copyright file="manage-tags.jsx" company="Microsoft Corporation">
...
// Page where user can manage the tags
class ManageTagsContent extends Component {
    constructor(props) {
        super(props);
            ...
            elements.push(<Flex className="tag-container" vAlign="center">
                <Flex.Item size="size.half">
                    <Flex column>
                        ...
                        <Text content={teamworkTag.description} />
                    </Flex>
                </Flex.Item>
    ...
    render() {
        return (<Flex className="enableer-page-container" column >
             <FlexItem>
                <div>
                    <button className="enableer-back-button" onClick={() => this.props.navigate("/dashboard")}>
                        Back to Dashboard
                    </button>
                </div>
            </FlexItem>
...
// Wrapper to provide navigate prop
const ManageTags = (props) => {
    const navigate = useNavigate();
    return <ManageTagsContent {...props} navigate={navigate} />;
}
